      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            <h1 className="text-2xl font-black text-slate-900 tracking-tight truncate">تعديل بيانات العميل</h1>
            <p className="text-sm font-bold text-slate-500 mt-0.5 truncate">{client.name}</p>
          </div>
        </div>
