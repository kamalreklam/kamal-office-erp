    ...
    <div className="pb-32 bg-gradient-to-br from-indigo-50/50 via-white to-blue-50/30 min-h-screen" dir="rtl">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">إضافة منتج جديد</h1>
            <p className="text-sm font-bold text-slate-500 mt-0.5">أدخل صنفاً جديداً للكتالوج في مستودع حلب</p>
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <textarea
              placeholder="تفاصيل ووصف مختصر للمنتج..."
